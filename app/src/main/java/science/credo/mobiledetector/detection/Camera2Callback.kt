...
class Camera2Callback(private val mContext: Context) : CameraCaptureSession.CaptureCallback(), ImageReader.OnImageAvailableListener {
    ...
    override fun onImageAvailable(reader: ImageReader?) {
        ...
        doAsync {
            ...
            Log.d(TAG, "Speed: ${System.currentTimeMillis() - timestamp}ms, bh ${timestampbh - timestamp}, ah ${timestampah - timestampbh}")
        }
