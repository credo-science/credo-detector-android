...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        silentLogin(savedInstanceState)
    }
    ...
    fun silentLogin(savedInstanceState: Bundle?){
        ...
        if (savedLogin != null && savedPassword != null) {
            baseSilentLogin(savedLogin, savedPassword)
        } else {
    ...
    fun baseSilentLogin(login: String, password: String) {
